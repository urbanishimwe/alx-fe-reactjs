...
const AddRecipeForm = () => {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        const notValid = title === '' || summary === '' || instructions === '' || ingredients.split('\n').length < 2
        if(notValid) {
    ...
    return (
        <form className="max-w-sm mx-auto">
            ...
            <textarea onChange={e => setInstructions(e.target.value)} value={instructions} id="instructions" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>
