...
const HomePage = () => {
    ...
    return (
        <div className='grid grid-cols-1 grid-cols-2 grid-cols-3'>
            {recipes.map(e =>
                <NavLink className="user-profile bg-gray-100 md:p-8 sm:p-4 sm:max-w-xs md:max-w-sm mx-auto mx-auto rounded-lg shadow-lg my-20 hover:shadow-xl" key={e.id} to={`/recipe/${e.id}`}>
